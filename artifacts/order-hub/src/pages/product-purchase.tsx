          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="grid gap-4 py-4">
              <div className="grid gap-2">
                ...
                {autofilledFromName && (
                  <p className="text-xs text-emerald-600">
                    Auto-filled from previous purchase of{" "}
                    <span className="font-medium">{autofilledFromName}</span>
                    . Just update the rate &amp; marketplace details.
                  </p>
                )}
              </div>
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="grid gap-2">
                  <Label htmlFor="purchase-rate">Rate per unit (₹)</Label>
                  <Input
                    id="purchase-rate"
                    type="number"
                    min={0}
              ...
              <div className="grid gap-2">
                ...
                <input
                  ...
                  data-testid="input-purchase-photo"
                />
                {form.imageUrl ? (
                  ...
                  <Button
                    ...
                    data-testid="button-upload-purchase-photo"
                  >
                    {uploadingPhoto ? (
                      <>
                        <Loader2 className="mr-2 h-4 w-4 animate-spin" />
